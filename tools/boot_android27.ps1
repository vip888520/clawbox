...
$dir = 'C:\Temp\clawbox-arm27'
$env:PATH = "$q;" + $env:PATH
$env:QEMU_AUDIO_DRV = 'none'
$serial = 'C:\Temp\clawbox-arm27\serial.log'
...
& "$q\qemu-system-aarch64.exe" -M virt -cpu cortex-a53 -smp 1 -m 2048 `
  ...
  -serial "file:$serial" -no-reboot 2>&1 | Tee-Object -FilePath (Join-Path $ws 'qemu27-console.log')
